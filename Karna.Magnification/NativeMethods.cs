...
namespace Karna.Magnification
{
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport("Magnification.dll", CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool MagSetImageScalingCallback(IntPtr hwnd, ImageScalingCallback callback);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public delegate bool MagImageScalingCallback(HWND hwnd, IntPtr srcdata, MAGIMAGEHEADER srcheader, IntPtr destdata, MAGIMAGEHEADER destheader, 
            RECT unclipped, RECT clipped, HRGN dirty);*/

        [UnmanagedFunctionPointer(CallingConvention.Winapi)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public delegate bool ImageScalingCallback(IntPtr hwnd, IntPtr srcdata, MAGIMAGEHEADER srcheader, IntPtr destdata, MAGIMAGEHEADER destheader,
            RECT unclipped, RECT clipped, IntPtr dirty);
